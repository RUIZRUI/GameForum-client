...
namespace GameForum
{
    public partial class IOSGameDetailForm : Form
    {
        private string gameId;
        private int commentCount;
        private string rootDir = "D:\\MySQL";

        public IOSGameDetailForm()
        {
            InitializeComponent();
        }

        public IOSGameDetailForm(string gameId)
        {
            InitializeComponent();
            this.gameId = gameId;
        ...
        /// </summary>
        /// <returns></returns>
        private IOSGame getIOSGame()
        {
            string url = "http://localhost:8080/gameforum/v1/game/getIOSGame?gameId=" + gameId;
            ...
            {
                // JSON反序列化
                IOSGame iosGame = JsonConvert.DeserializeObject<IOSGame>(message["iosGame"].ToString());
                return iosGame;
            }
            else
            {
        ...
        private void fillDataWithGame()
        {
            ...
            gameCollect.Name = "gameCollect_" + iOSGame.Game_id;
        ...
        {
            // 发送get请求
            string url = "http://localhost:8080/gameforum/v1/comment/getCommentByGame?gameId=" + gameId;
            string value = HttpHelper.sendGetRequest(url);
