...
namespace GameForum
{
    public class IOSGame
    {
        ...
        public IOSGame(string game_id, string game_name, string game_slogan, string game_version, string game_platform, string game_type, string game_release_date, string game_release, string game_language, float game_score, int game_rater_num, string game_img)
        {
            Game_id = game_id;
            Game_name = game_name;
