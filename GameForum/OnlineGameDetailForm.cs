...
namespace GameForum
{
    public partial class OnlineGameDetailForm : Form
    {
        private string gameId;
        private int commentCount;
        private string rootDir = "D:\\MySQL";

        public OnlineGameDetailForm()
        {
            InitializeComponent();
        }

        public OnlineGameDetailForm(string gameId)
        {
            InitializeComponent();
        ...
        private OnlineGame getOnlineGame()
        {
            string url = "http://localhost:8080/gameforum/v1/game/getOnlineGame?gameId=" + gameId;
            ...
            {
                // JSON反序列化
                OnlineGame onlineGame = JsonConvert.DeserializeObject<OnlineGame>(message["onlineGame"].ToString());
                return onlineGame;
            }
            else
            {
        ...
        {
            OnlineGame onlineGame = getOnlineGame();
            if (onlineGame == null)
            {
                return;
            }
            ...
            gameOperator.Name = "gameOperator";
            ...
            gameTestTime.Name = "gameTestTime";
            ...
            gameCollect.Name = "gameCollect_" + onlineGame.Game_id;
        ...
        private int fillDataWithComment()
        {
            ...
            foreach (Comment comment in commentList)
            {
                index++;
                // 评论背景
                // 有游戏简介时 new Point(190, 860)，没有游戏简介时 new Point(190, 670)
